                ...
                <div class="row">
                    <div class="col-lg-6">
                         ...
                         <div class="form-group">
                         		<label>Search driver with ID</label>
                        </div>
                              <form action="driverDeletebyID.php" method="post" name="driverID_search" >  
                          <div id="search" class="form-group input-group">
                                <input type="text" class="form-control" name="searchID"  placeholder="A/00123/14">
                             ...
                             <div class="form-group">
                         		<label>Search driver with Name</label>
                        </div>
                             <form action="driverDeletebyID.php" method="post" name="driverName_search">  
                          <div id="search1" class="form-group input-group">
                                <input type="text" class="form-control" name="searchName">
                                <span class="input-group-btn"><input class="btn btn-default"  type="submit" name="submit1" value="search"></span>
