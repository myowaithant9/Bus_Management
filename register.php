...
$errorCount;
	...
	if(isset($_POST['registerSubmit'])) 
		...
		$query = "INSERT INTO staff (employeeId,password,confirmPassword,name,nrc,address,phone,gender) VALUES
		('" . $_POST["employeeID"] . "', '" . $_POST["password"] . "', '" . $_POST["confirmPassword"] . "', '" . $_POST["firstName"] . "',  '" . $_POST["nrc"]. "', '" . $_POST["address"]. "', '" . $_POST["phoneNumber"]. "', '" . $_POST["gender"] . "')";
		$result = $db_handle->insertQuery($query);
		if(!empty($result)) {
			$successmsg = "You have registered successfully!";	
			unset($_POST);
		} else {
			$errormsg = "Problem in registration. Try Again!";	
		}
                    ...
                    <div class="col-md-8">
                        ...
                        <form role="form" action="register.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="employeeID" id="employeeID" disabled placeholder="Enter employee ID" 
								 value="<?php  if ( isset( $_POST["employeeID"] ) && $errorCount !=0) echo $_POST["employeeID"]?>"/>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="firstName" id="firstName" placeholder="John" value="<?php
								if(isset($_POST["firstName"]) && $errorCount !=0)
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="09*********" value="<?php  if ( isset( $_POST["phoneNumber"] ) && $errorCount !=0) echo $_POST["phoneNumber"]?>">
							...
							<p>
								<input type="submit" value="Register" name="registerSubmit" id="registerSubmit" class="btn btn-info btn-fill"/>
								<input type="reset" value="Cancel" name="cancel" id="cancel" class="btn btn-info btn-fill" />
							</p>
