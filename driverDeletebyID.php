...
$query="select * from driver where driverId='$searchID'";
...
$query1="select * from driver where driverName = '$searchName'   ";
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                             <form role="form" action="driverDeletebyIDop.php" method="post">
                          
                                <div class="form-group">
                                <label>Employee ID</label>
                                <input class="form-control" type="text" name='driverID' value="<?php echo $driverID ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name='driverName' value="<?php echo $driverName ?>" >
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $nrcNumber ?>">
                            </div>
                            
                              <div class="form-group">
                                <label>Phone Number</label>
                                <input class="form-control" type="text" value="<?php echo $phoneNumber ?>">
                            </div>
                              ...
                              <input class="btn btn-danger" type="submit" name="deleteSubmit" value="Delete">
                           <input class="btn btn-info" type="reset" name="" value="Cancle">
