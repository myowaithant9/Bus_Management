...
if ($level=="Driver")
{
	$salary+=$totalIncome*0.25;
}else 
{
	$salary+=$totalIncome*0.15;
}


if($level=="Driver"){
 $sql=$conn->query("Insert into driverSalary (date,DriverName,Salary) values ('$date','$name','$salary')"); 
}else 
$sql=$conn->query("Insert into assistantSalary values ('$date','$name','$salary')");
    ...
    <div class="main-panel">
     ...
     <div class="container-fluid">
                ...
                <div class="alert alert-info">
                   <h3> Your today salary is <strong><?php echo $salary ?></strong></h3>.
                </div>
                <a href="salary.html" class="btn btn-info btn-md btn-fill">Ok</a>
                <!-- /.row -->
