...
$query="select * from bus where busID='$searchID'";
    ...
    <div class="main-panel">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
 <form role="form" action="busDeleteop.php" method="post">  
                            <div class="form-group">
                                <label>Bus ID</label>
                                 <input class="form-control" type="text" name='busID' value="<?php echo $busID ?>">
                            </div>
                              <div class="form-group">
                                <label>Bus Color</label>
                                <input class="form-control" type="text" name='busColor' value="<?php echo $busColor ?>">
                            </div>
