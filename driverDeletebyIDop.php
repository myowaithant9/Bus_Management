...
$query="delete from driver where driverId = '$eID'  " ;
$conn->exec($query);
//echo 'delete success';
} 
if (isset($_POST['driverName'])){
$eName = $_POST['driverName'] ; 
$query="delete from driver where driverName = '$eName'  " ;
$conn->exec($query); 
}
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="alert alert-success">
                    <strong>Success</strong> You successfully delete the selected Driver.
                </div>
                <a href="driverDeleteSearch.php" class="btn btn-success">Ok</a>
                <!-- /.row -->
